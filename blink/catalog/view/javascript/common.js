		...
		$.ajax({
			...
			success: function(json) {			
				...
				if (json['success']) {
					...
					setTimeout(function () {
						$('#cart > button').html('<i class="material-icons shopping-cart">shopping_cart</i><span id="cart-total"> ' + json['total'] + ' </span><span class="cart-heading">Cart</span>');
					}, 100);
	...
	'remove': function(key) {
		$.ajax({
			...
			success: function(json) {
				// Need to set timeout otherwise it wont update the total
				setTimeout(function () {
					$('#cart > button').html('<span id="cart-total"><i class="material-icons shopping-cart">shopping_cart</i> ' + json['total'] + '</span><span class="cart-heading">Cart</span>');
				}, 100);
